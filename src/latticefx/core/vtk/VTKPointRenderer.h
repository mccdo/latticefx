...
#ifndef __LATTICEFX_CORE_VTK_POINTRENDERER_H__
#define __LATTICEFX_CORE_VTK_POINTRENDERER_H__ 1
...
class LATTICEFX_CORE_VTK_EXPORT VTKPointRenderer : public lfx::core::VectorRenderer, public IVTKRenderer
{
public:
    ///Default constructor
    ///We are really a fancy lfx::core::VectorRenderer specific to VTK data
    VTKPointRenderer( bool renderSpheres=false, const std::string& logName = std::string( "" ) )
        :
    ...
    ///Destructor
    virtual ~VTKPointRenderer()
    {
        ;
    }

	///Get a string name for this class
	virtual std::string getClassName() const { return std::string( "VTKPointRenderer" ); }
	...
	bool setRenderSpheres( bool value );
...
typedef boost::shared_ptr< VTKPointRenderer > VTKPointRendererPtr;
