...
#ifndef __LATTICEFX_CORE_VTK_POLYDATAPOINTS_RTP_OPERATION_H__
#define __LATTICEFX_CORE_VTK_POLYDATAPOINTS_RTP_OPERATION_H__ 1
...
class LATTICEFX_CORE_VTK_EXPORT VTKPolyDataPointsRTP : public VTKBaseRTP
{
public:
    ...
    ///Destructor
    virtual ~VTKPolyDataPointsRTP()
    {
        ;
    }

	///Get a string name for this class
	virtual std::string getClassName() const { return std::string( "VTKPolyDataPointsRTP" ); }
...
typedef boost::shared_ptr< VTKPolyDataPointsRTP > VTKPolyDataPointsRTPPtr;

}
}
}
// __LATTICEFX_CORE_VTK_POLYDATAPOINTS_RTP_OPERATION_H__
#endif